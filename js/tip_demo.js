...
const tipOptionHandler = (event) => {
   if (bill.value === null || bill.value === 'undefined' || bill.value === '0' || bill.value === '' || bill.value === "") {
        alert("Please enter a bill value")     
   } else {
        if (people.value === null || people.value === 'undefined' || people.value === '0' || people.value === '' || people.value === "") {
